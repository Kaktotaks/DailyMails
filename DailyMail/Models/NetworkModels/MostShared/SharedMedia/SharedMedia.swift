...
struct SharedMedia : Codable {
	...
	let sharedMediaMetadatas : [SharedMediaMetadata]?
	...
	enum CodingKeys: String, CodingKey {
		...
		case sharedMediaMetadatas = "media-metadata"
	}
	...
	init(from decoder: Decoder) throws {
        ...
        sharedMediaMetadatas = try values.decodeIfPresent([SharedMediaMetadata].self, forKey: .sharedMediaMetadatas)
	}
